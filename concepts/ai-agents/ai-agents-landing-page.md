...
The goal is to start with the simplest definition, then build up the pieces that make agents useful in practice: tools, planning, memory, retrieval, guardrails, and orchestration.
...
2. [[ai-agents-lesson-02-tools-actions-and-observation-loops.md|Lesson 2: Tools, Actions, and Observation Loops]]
3. [[ai-agents-lesson-03-planning-memory-and-state.md|Lesson 3: Planning, Memory, and State]]
4. [[ai-agents-lesson-04-retrieval-context-and-long-context-work.md|Lesson 4: Retrieval, Context, and Long-Context Work]]
5. [[ai-agents-lesson-05-guardrails-evaluation-and-reliability.md|Lesson 5: Guardrails, Evaluation, and Reliability]]
6. [[ai-agents-lesson-06-single-agent-and-multi-agent-architectures.md|Lesson 6: Single-Agent and Multi-Agent Architectures]]

## How to read the series
- Read lessons in order the first time
- Revisit lessons 2 through 5 when you start building or reviewing an agent
- Use lesson 6 to decide whether a simple agent, router, or multi-agent design fits the task
