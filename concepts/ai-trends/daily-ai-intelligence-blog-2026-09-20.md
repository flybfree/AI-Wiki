...
### 4. Youth safety is becoming product architecture
...
### 5. Consumer trust depends on truthful self-description
...
### 6. Realistic benchmarks are moving beyond toy tasks
...
### 7. Model-asset security belongs inside AI safety
...
- **Included:** Anthropic’s alignment/security update; Thinking Machines’ open-weight framework and task-expertise RL report; OpenAI’s Australian Youth Safety Blueprint; Meta Muse privacy/explainability coverage; Google Research’s MilleMiglia; and Exfiltrate Your Weights.
- **Excluded:** non-AI biomedical and unrelated business captures were not promoted.
