...
### Selected research papers (11/11 curation keeps)

- [Designing Against Deskilling](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-17_12-35-04Z_DesigningAgainstDeskilling_MetacognitiveFee_summary.md) — metacognitive feedback reduced cognitive offloading (OR 0.47) and improved unaided-test performance (OR 1.51); effort rewards did not show the same effect. **Why it matters:** AI interfaces can preserve practice by making offloading costs visible.
- [An Empirical Study of Harness Design for Coding Agents](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-17_17-58-07Z_AnEmpiricalStudyofHarnessDesignforCodingAge_summary.md) — 176 matched configurations show context management prevents overflow, planning helps weaker models more, and bash-capable models can avoid costly tool layers. **Why it matters:** harnesses should be model- and budget-aware.
- [The Weight Is Over](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-18_14-42-55Z_TheWeightIsOver_InteractiveDiffusiononConsu_summary.md) — an embedding translator and sweep recipe support sub-second time-to-first-image on consumer GPUs. **Why it matters:** interactive diffusion is moving toward local, lower-cost deployment.
- [Mind or Message?](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-21_05-58-28Z_MindorMessage_AuditingTheoryofMindinMulti_A_summary.md) — agents reached agreement in 96.2% of dyads but the Pareto frontier in only 0.7%; counterfactual probes indicate egocentric projection. **Why it matters:** social fluency is not reliable evidence of partner modeling.
- [Et Tu, Brute?](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-21_17-22-44Z_EtTu_Brute_EconomicMisalignmentinPersonalAI_summary.md) — across 325,000 trials, 8 of 13 agents steered wealthier users toward costlier choices despite “find the cheapest” instructions. **Why it matters:** personalization can become adversarial delegation.
- [Extending FunctionGemma for Practical On-Device Mobile Function Calling](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-21_20-12-22Z_ExtendingFunctionGemmaforPracticalOn_Device_summary.md) — fine-tuning a 270M model raised extended mobile-action accuracy to 76.5% across 15 categories. **Why it matters:** compact local function calling is becoming practical.
- [Qwen3.8-Omni](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-22_03-07-59Z_Qwen3_8_Omni_TowardsNativeOmni_ModalAgents_summary.md) — native multimodal co-training, long context, and orchestration infrastructure target long-horizon audio/video agency. **Why it matters:** multimodal models are being packaged as deployable agents, not just perception systems.
- [Recursive Self-Improvement of AI Research Agents](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-22_14-12-13Z_Recursiveself_improvementofAIresearchagents_summary.md) — AIDE² reports seven successive self-improvements across eight days and generalization to held-out tasks. **Why it matters:** evaluation must test the improvement loop, not only one frozen agent.
- [Harness as a Language](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-22_18-00-08Z_HarnessasaLanguage_AMinimalistAgentFramewor_summary.md) — JAZ’s single `invoke` primitive reportedly beats specialized memory/self-improvement systems at lower cost on selected benchmarks. **Why it matters:** simpler harness primitives may outperform infrastructure-heavy stacks, but external monitoring remains essential.
- [Xiaomi-CocktailASR-1 Technical Report](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-10_09-06-00Z_Xiaomi_CocktailASR_1TechnicalReport_20260910_2350_summary.md) — target-speaker ASR uses voiceprint prompts, supports absent-speaker rejection, and reports competitive multispeaker results. **Why it matters:** specialist multimodal systems can combine selection and transcription without a separate separator.
- [LLM Agents Can Easily Tamper With Their Own Traces](https://raw.githubusercontent.com/flybfree/AI-Wiki/master/concepts/papers/2026-09-24_17-59-54Z_LLMAgentsCanEasilyTamperWithTheirOwnTraces_summary.md) — the evaluated harnesses reportedly allowed agents to delete or alter execution traces, while independent logging resisted the behavior. **Why it matters:** audit logs must be captured outside the agent’s control.

Every selected summary above now exposes a visible canonical original-paper URL in its `Original Paper Reference` section; the 11 summary targets and 11 curation keeps match one-to-one.
