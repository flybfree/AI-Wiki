...
- The PJM event described by [TechCrunch](https://techcrunch.com/2026/07/25/one-fallen-powerline-exposed-a-growing-AIdatacenter-problem-heres-how-to-fix-it/) is a warning about synchronized AI load behavior, not just grid capacity.
