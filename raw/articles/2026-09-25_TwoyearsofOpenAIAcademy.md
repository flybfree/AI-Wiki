...
This month, we also[introduced new Academy learning paths](https://openai.com/index/expanding-openai-academy-with-new-learning-paths/) for knowledge workers, developers, leaders, educators, and college students. Learners can take courses relevant to their roles and earn Academy course badges by passing assessments.
...
## Metadata
- **Source**: [Original Article](https://openai.com/index/two-years-of-openai-academy)
