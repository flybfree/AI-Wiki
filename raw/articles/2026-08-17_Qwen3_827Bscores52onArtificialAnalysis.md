...
Qwen3.8 27B is released under the Apache 2.0 license. This license allows commercial use.
View license
...
Qwen3.8 27B is an open weights model that can be self-hosted.
View providers
Where can I use Qwen3.8 27B?
Qwen3.8 27B is an open weights model that can be downloaded and self-hosted.
Compare providers

## Metadata
- **Source**: [Original Article](https://artificialanalysis.ai/models/qwen3-8-27b)
