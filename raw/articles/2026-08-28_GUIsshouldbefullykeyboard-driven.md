...
Hacker
News
that encouraged application
developers to stop making terminal user interfaces
1
...
, I
also
greatly appreciate all TUIs that allow me to
...
to be fully keyboard-driven, this does not tip the scale in favor of developing TUIs over GUIs
3
.
What it does is highlight the inadequacies of keyboard navigation in many GUI applications.
There is nothing preventing a GUI from being fully keyboard-driven
4
just like — or even better
than — a TUI.
...
just as it should be possible to perform every
action with a pointing device, every action should also be possible with the
keyboard
and that
it should be possible to move around and interact with every part of your user interface
using the
keyboard
.
...
For my first ever GUI application,
Klisi
...
↩
There are other more compelling arguments towards tipping that scale, for example ease of
portability.
↩
Of course, the dexterity achieved via mouse is still preferred — or even required — for some
tasks.
↩
Tags:
programming
...
add comment
Name or nickname
The name will be linked to your email address.
If you change your name, your old name will be replaced in all comments.
All comment data will be automatically encrypted with the
public key
.
Password
The password is used to authenticate against your email address.
The password is linked to your email address after your first comment.
After the first comment, you have to keep using the same password.
All comment data will be automatically encrypted with the
public key
.
You may change or reset your password at the
account
page.
Comment
...
## Metadata
- **Source**: [Original Article](https://ckardaris.com/blog/2026/08/28/keyboard-driven-guis.html)
