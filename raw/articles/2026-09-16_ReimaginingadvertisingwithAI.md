...
Starting today, businesses managing their customers in HubSpot can connect a [ChatGPT Ads account⁠(opens in a new window)](https://hubs.la/Q04tW3sT0), create ads, track performance, and follow up on leads directly in HubSpot powered by their HubSpot context.Also available today, US-based Shopify merchants can use the new [ChatGPT Ads app⁠(opens in a new window)](https://apps.shopify.com/chatgptads) in the Shopify App Store to create and manage ChatGPT ad campaigns. Products are already integrated through Shopify Catalog, so merchants can start running these ads and tracking performance right away. The app will be available internationally in markets where ChatGPT Ads are available starting September 23
...
## Metadata
- **Source**: [Original Article](https://openai.com/index/reimagining-advertising-with-ai)
