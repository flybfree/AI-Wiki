...
In
a new blog post
, Anthropic CEO Dario Amodei not only echoed the call to “pace the frontier,” but also outlined three broad strategies for doing so. And he said Anthropic is “unilaterally committing” to one of them.
The
...
His proposed first step would involve “embedded evaluators” from third-party organizations like
METR
...
not reporting an incident where its AI agents took over a German wiki form
.)
...
Such coordination might seem unlikely, both due to
the apparent animosity between Altman and Amodei
and also because their companies are
...
the spectre of Chinese AI dominance
