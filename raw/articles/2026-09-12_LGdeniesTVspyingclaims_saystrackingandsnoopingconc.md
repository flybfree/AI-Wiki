...
, TV manufacturer
LG
has strongly denied recent claims that its smart TVs constantly log and upload data, record
audio
while in standby, while confirming they scan local area networks for other devices, a feature common in smart TVs and media devices. The statement follows an investigation published online by
Gamers Nexus
,
which claims LG is operating "216,000,000" spy TVs.
Earlier this week,
Gamers Nexus
published a video on YouTube claiming that LG smart TVs have several
security
...
"The claims made in the recently published video are not true," LG told
Tom's Hardware
in a statement. "LG TVs process voice data only when the voice button on the remote control is pressed and held, or when a wake word such as 'Hi LG' is recognized after the user has activated the Far-Field voice recognition feature."
...
Addressing some of the claims in more detail, LG stated that its smart TVs don't collect, record, or transmit ambient conversations in the home
unless
voice functionality has been activated by a user. It further stated that its far-field voice recognition tech (Hi LG) must be activated by a user before the TV starts listening, much like Apple's "Hey Siri" mechanism for iPhone.
...
Tom's Hardware
has not independently verified either the claims made by
Gamers Nexus
in its documentary or LG's counterclaims regarding the issue. LG's full statement follows:
LG Statement:
...
Protecting Voice Privacy:
We ensure that your LG TV
does not
collect, record or transmit ambient conversations in your home,
unless voice functionality has been intentionally activated by the user.
Far-Field Voice Recognition ("Hi LG"):
This feature must be manually activated by the user before the TV begins listening for the specific wake word. Audio processing occurs
only when
voice functionality has been activated by the user and a wake work (such as “Hi LG”) is detected.
Standby Mode Operation:
When the TV is in standby mode and appears to be turned off, it only monitors for the wake word if you have previously enabled the Far-Field feature. If no wake word is detected, the audio used for wake word detection is processed locally on the TV, promptly deleted, and is not transmitted to LG servers.
Transparent and Useful Connectivity:
...
Data security is a top priority for LG. We continuously monitor our platform and partner with independent security experts to identify vulnerabilities and deliver timely security updates.
Full Control Over Data and Terms:
LG Electronics is committed to providing transparency and rejecting deceptive practices (dark patterns), ensuring users can choose their preferred privacy and consent options directly through their TV settings.
...
Reply
they'll deny until it goes to court where discovery will prove it's all true.
...
Reply
I won't be surprised a lot of electronic devices that we are using are surreptitiously logging our activities and tracking what we do. The question is, to what extent, rather than if they actually do it. I mean if you think about it, the concept of "smart" household electronics that require you to be connected online, is like smart at collecting information on the users.
Reply
They are lying from the fact their statement only attempts to rebuke items that have plausible deniability but anything that is definitive yet not part of their partially explainable agenda is omitted. That's standard slight of hand in pretty lawyer speak. I say a good class action suit should bring them to court and their devices can be torn down and examined by third party analysts. I bet they will attempt a non disclosure settlement where only people that opt in get some kind of BS reimbursement and the thing dies away. Its classic by now. The best action is to not let them get away. Nexus is correct to make noise and expose.
Reply
Ah, the "our users are confused" defense.
Protecting Voice Privacy:
We ensure that your LG TV
does not
collect, record or transmit ambient conversations in your home,
...
Regards.
Reply
Smart assistants ranging from TVs to Alexa devices to phones listen for wake words. Programmers want to do things as quickly and easily as possible, and that means not sending data until the wake word is recognized. Sending it to the server would add massive overhead because instead of a few words being sent when a command is issued, they'd have to process hundreds of times as much data for no reason. The compromise is to limit wake words to a small handful, or perhaps a single one, so local programming can handle it. Users who are frustrated that they can't customize the wake word need to realize that it would require changing the firmware because it's processed locally.
...
Reply
If I recall right, is't this the second try to monitor you.
...
Smart assistants ranging from TVs to Alexa devices to phones listen for wake words. Programmers want to do things as quickly and easily as possible, and that means not sending data until the wake word is recognized. Sending it to the server would add massive overhead because instead of a few words being sent when a command is issued, they'd have to process hundreds of times as much data for no reason. The compromise is to limit wake words to a small handful, or perhaps a single one, so local programming can handle it. Users who are frustrated that they can't customize the wake word need to realize that it would require changing the firmware because it's processed locally.
Companies have privacy policies by law, and have to follow them by law. Going through the extra effort to upload massive amounts of data for no reason and store enough data to require a data farm for data that has no use is not something that any company would pay for.
Going to go out on a limb and say you never watched any of the Gamers Nexus content.
Reply
View All 64 Comments
Show more comments

## Metadata
- **Source**: [Original Article](https://www.tomshardware.com/tech-industry/big-tech/lg-strongly-denies-tv-security-claims-says-tracking-and-snooping-concerns-not-true-online-investigation-claims-216-000-000-spy-tvs-record-audio)
