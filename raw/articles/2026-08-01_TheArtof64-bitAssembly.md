...
source_url: https://nostarch.com/art-64-bit-assembly-v2
source_feed: Hacker News
ai_relevance: include
ai_topic: health-ai
ai_reason: meets AI relevance threshold
scraped: 2026-08-01 11:01
---
...
Author Bio
Randall Hyde
has spent decades writing assembly for medical devices, nuclear systems, and embedded hardware where correctness is not optional. He taught assembly language programming at the university level and is the author of
The Art of Assembly Language
,
The Art of ARM Assembly
, and the Write Great Code series, all from No Starch Press.
Table of contents
Acknowledgments
Introduction
...
## Metadata
- **Source**: [Original Article](https://nostarch.com/art-64-bit-assembly-v2)
