...
Guided by OpenAI’s [ads principles](http://openai.com/index/our-approach-to-advertising-and-expanding-access/), we keep conversations private from advertisers and never sell customer data. Ads in ChatGPT are always clearly labeled and separate from ChatGPT’s answers, and advertising does not influence the answers ChatGPT provides. People also have control over ad personalization, with ad-free paid plans available for those who prefer not to see ads.
...
## Metadata
- **Source**: [Original Article](https://openai.com/index/chatgpt-ads-expands-across-europe)
