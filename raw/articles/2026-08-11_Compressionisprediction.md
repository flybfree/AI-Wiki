...
## [](http://ngrok.com/blog/compression-is-prediction/#how-compression-works)How compression works
...
## [](http://ngrok.com/blog/compression-is-prediction/#the-anatomy-of-a-compressor)The anatomy of a compressor
...
## [](http://ngrok.com/blog/compression-is-prediction/#squishing-data-with-probabilities)Squishing data with probabilities
...
### [](http://ngrok.com/blog/compression-is-prediction/#arithmetic-coding)Arithmetic coding
...
### [](http://ngrok.com/blog/compression-is-prediction/#decompressing-arithmetic-codes)Decompressing arithmetic codes
...
## [](http://ngrok.com/blog/compression-is-prediction/#how-probabilities-affect-compression)How probabilities affect compression
...
|  | A B A B A A C | A A A A A A A A A A B C |
| --- | --- | --- |
...
## [](http://ngrok.com/blog/compression-is-prediction/#entropy)Entropy
...
Quick refresher: **logarithms** are the reverse of exponents. For example,

**2 to the power of 4**

asks “What is 2 to the power of 4?”. On the flip side,

**log base 2 of 16**

asks “2 to the power of _what number_ equals 16?”

If we plug in our animal probabilities, you’ll see we get the same number of _bits_ as _guesses_ from our decision tree:

| Symbol | negative log base 2 of P | Bits |
| --- | --- | --- |
| bird | negative log base 2 of 0.5 | 1 |
| squirrel | negative log base 2 of 0.25 | 2 |
| cat | negative log base 2 of 0.125 | 3 |
| fox | negative log base 2 of 0.0625 | 4 |
| bear | negative log base 2 of 0.0625 | 4 |
...
## [](http://ngrok.com/blog/compression-is-prediction/#context-matters)Context matters
...
## [](http://ngrok.com/blog/compression-is-prediction/#language-modeling-and-compression)Language modeling and compression
...
Bermuda the model’s confident guess negative log base 2 of 0.82 =0.29 bits

Spain the actual next word negative log base 2 of 0.02 =5.64 bits
...
## [](http://ngrok.com/blog/compression-is-prediction/#compression-in-the-wild)Compression in the wild
...
## [](http://ngrok.com/blog/compression-is-prediction/#two-sides-same-coin)Two sides, same coin
