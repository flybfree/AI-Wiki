...
or merely
elicited
. We constrain the training distribution itself: an 88B-token
...
Three scales (0.6B / 1.3B / 5B) trained from scratch on LittleCurriculum: chattable models
        with an interpretable knowledge boundary. Each ships with a matched
Unfiltered
control
...
GRPO
: math specialists post-trained on MathCAMPS; responses may exhibit a tendency toward math-oriented output.
Chatty
: variants tuned for general chat behavior.
Scale
LittleLearner · K–5
chatty
...
## Metadata
- **Source**: [Original Article](https://littlelearner-ll.github.io/)
