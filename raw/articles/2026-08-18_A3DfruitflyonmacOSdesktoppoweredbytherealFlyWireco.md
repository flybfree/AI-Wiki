...
source_url: https://github.com/DenisSergeevitch/desktop-fly
source_feed: Hacker News
ai_relevance: include
ai_topic: agents-tools
ai_reason: meets AI relevance threshold
scraped: 2026-08-18 19:12
---
...
LC4 (104) + LPLC2 (210)
looming-detector visual neurons
DNp01 / Giant Fiber (GF) (2)
— the escape command neuron
DNa01 + DNa02 (4)
steering neurons ·
DNp09 (2)
forward walking
...
grooming ·
MDN (4)
backward walking ("moonwalker")
DNp02/DNp04/DNp11 (6)
escape-maneuver (wing) neurons
...
## Metadata
- **Source**: [Original Article](https://github.com/DenisSergeevitch/desktop-fly)
