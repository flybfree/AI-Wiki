...
Open source, runs locally. Plug in any of the keys above (GPT-5.5, Claude Opus 4.7, Gemma 4, GLM-5.1, Llama 4) and it drives your real Mac. On Windows or Linux? We will email you when it lands.
Get download link
