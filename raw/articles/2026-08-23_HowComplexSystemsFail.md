...
Catastrophe requires multiple failures â single point failures are
            not enough.
...
Post-accident attribution to a âroot causeâ is fundamentally
            wrong.
...
1
1
Anthropological field research provides
...
ex post facto
accident analysis of human performance is
...
2
This is not a feature of medical
...
After accidents, the overt failure often appears to have been
          ...
          after accidents; in general,
post hoc
analysis regards these
...
Views of âcauseâ limit the effectiveness of defenses against future
            events.
...
Cook & Woods (1994), âOperating at the Sharp End: The Complexity
            of Human Error,â in MS Bogner, ed.,
Human Error in Medicine
,
            Hillsdale, NJ; pp. 255-310
Woods, Johannesen, Cook, & Sarter (1994),
Behind Human Error: Cognition, Computers and Hindsight
,
...
## Metadata
- **Source**: [Original Article](https://how.complexsystems.fail/)
