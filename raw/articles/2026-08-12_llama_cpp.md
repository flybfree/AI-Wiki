...
plugin and launch
Pi
. It will automatically discover your local model. No config, no API keys. Files stay on your machine, requests never leave it.
# 1. Serve a model
llama serve
...
## Metadata
- **Source**: [Original Article](https://llama.app)
