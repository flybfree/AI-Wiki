---
title: Is the Industrial Revolution a good precedent for explosive growth today?
date: 2026-08-02
url: https://mattsclancy.github.io/2026/07/27/industrial-revolution-growth.html
type: article-full-text
tags: [news, ai-research, full-text]
source_url: https://mattsclancy.github.io/2026/07/27/industrial-revolution-growth.html
source_feed: Hacker News
ai_relevance: include
ai_topic: safety-governance
ai_reason: meets AI relevance threshold
scraped: 2026-08-02 07:01
---
...
All estimates use the
Maddison Project Database 2023
, which reports GDP per capita in 2011 USD and population in thousands. The final section considers some objections to the relevancy of this analysis.
...
[UK annual GDP per capita growth, 1252–1652]
...
[UK 20-year compound annual growth, 1272–1652]
...
[Annual GDP per capita growth, modern analogues]
...
[Share of countries with at least one 10× growth year, by baseline growth rate]
...
Today the story is very different. In the contemporary USA, 10× the compound growth rate implies annual growth of roughly 19% per year. Looking only at the experience of Americans living today, they have
never
experienced this level of growth, even for a single year.
...
[Annual GDP per capita growth, all countries, 1950–2022]
...
Pre-IR UK, 1252–1652
6.9%
Modern analogue countries (8 countries, 1960–2022)
5.5%
USA, 1950–2022
2.3%
All countries, 1950–2022
6.2%
...
As a response, note that the processes governing economic growth are only incompletely understood. An economy’s technology is certainly an important determinant of the ultimate
level
of output per person in an economy, but the rate of change at which output per person grows may be limited by many additional factors beyond the speed of technological progress. The rate of change of the economy, for example, might be governed in part by the rate of technological progress, but also by:
...
Given the incompleteness of our understanding, it is informative to look at historical precedent. If someone were to argue that a new policy, for example, would increase the growth rate from
x
to
y
, it is an informative exercise to ask how often we have seen growth reach
y
in the past.
...
Put another way, the Industrial Revolution’s long-run growth acceleration did not require the UK economy to hit unusually fast short-run growth rates by its own standards, but to hit them more often than it previously did. Explosive growth today
would
require hitting short-run growth rates that are unusually fast by contemporary standards.
...
The full code and data are in the
growth-acceleration
repository.
Data
File
Source
mpd2023_web.xlsx
Maddison Project Database 2023, sheet “Full data”
Dependencies
...
## Metadata
- **Source**: [Original Article](https://mattsclancy.github.io/2026/07/27/industrial-revolution-growth.html)
